...
function getQOTDIndexEastern(numQuestions) {
  ...
  // QOTD season starts October 18, 2025 at midnight Eastern Time
  const seasonStartDate = new Date('2025-10-18');
    ...
    container.innerHTML = `
      <div class="question-box">
        <div class="question-text" style="text-align: center; font-size: 1.1em; color: #666;">
          AP Chemistry Question of the Day season begins on September 29, 2025! Check back then for daily practice questions.
        </div>
      </div>
    `;
    return;
